...
if __name__ == '__main__':
    img_path = os.path.join('HW2_Harris_Corner_Detection\original.jpg')
...
# i. Gaussian smooth results: 𝜎=5 and kernel size=5 and 10 (2 images)
    ...
    save_img_path1 = os.path.join(r'HW2_Harris_Corner_Detection\results\Gaussian smooth results', 'gaussian_smooth_of_sigma_and_kernal_size_5.jpg')
    save_img_path2 = os.path.join(r'HW2_Harris_Corner_Detection\results\Gaussian smooth results', 'gaussian_smooth_of_sigma_and_kernal_size_10.jpg')
...
# (2) window size = 30x30 (1 image)
    ...
    plt.axis('off')
    plt.savefig(r"HW2_Harris_Corner_Detection\results\Structure tensor + NMS results\NMS_window_size_3.jpg")
    ...
    plt.axis('off')
    plt.savefig(r"HW2_Harris_Corner_Detection\results\Structure tensor + NMS results\NMS_window_size_30.jpg")
...
# B. Final results of rotating (by 30°) original images (1 image)    
    ...
    plt.axis('off')
    plt.savefig(r"HW2_Harris_Corner_Detection\results\Final results of rotating/Rotate_30.jpg")
...
# C. Final results of scaling (to 0.5x) original images (1 image)
    ...
    plt.axis('off')
    plt.savefig(r"HW2_Harris_Corner_Detection\results\Final results of scaling/Scaling.jpg")